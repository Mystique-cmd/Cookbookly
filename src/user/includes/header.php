    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="/user/index.php">Dashboard</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/user/my_recipes.php">My Recipes</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/user/favorites.php">My Favorites</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/user/my_reviews.php">My Reviews</a>
                </li>
                <li class="nav-item">
            ...
            <div class="d-flex">
                <a href="/user/logout.php" class="btn btn-outline-secondary me-2">Logout</a>
